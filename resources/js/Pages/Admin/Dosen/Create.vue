    ...
    <AdminLayout>
        <div class="mx-auto max-w-3xl space-y-6">
            <header>
                ...
                <h1 class="mt-1 text-2xl font-semibold text-zinc-950">Tambah dosen</h1>
                <p class="mt-2 text-sm text-zinc-600">
                    Akun dosen akan dibuat otomatis dengan role dosen.
                </p>
            </header>
            ...
            <form class="rounded-lg border border-zinc-200 bg-white p-6 shadow-sm" @submit.prevent="submit">
                <div class="grid gap-5 sm:grid-cols-2">
                    ...
                    <div>
                        <label class="block text-sm font-medium text-zinc-800" for="password">Password awal</label>
                        <input id="password" v-model="form.password" class="mt-2 w-full rounded-md border border-zinc-300 px-3 py-2 text-sm outline-none focus:border-emerald-600 focus:ring-2 focus:ring-emerald-600/20" placeholder="Default: password" type="password">
